...
"dead-rule — intentional?" findings for a human to confirm, not as
counterexamples ([verify-and-counterexamples.md](verify-and-counterexamples.md#human-in-the-loop-findings)).
