...
Ordinary policy, function, and built-site deployment does not need source and must leave this disabled.
Enable it only for a workflow that consumes source, such as clone/pull or an oApp opening.
