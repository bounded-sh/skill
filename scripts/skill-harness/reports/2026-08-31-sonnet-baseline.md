...
Subject: claude-sonnet-5 via `claude -p`, Tier A isolation, 14 tasks. Rates exclude void runs (canary hit or escape); `void` counts them. Lift = with minus without on mean check pass rate. Regenerated after an external review: checkers hardened (cap value resolved through @const, supply amount checked, authMode matched as an assignment only, no waiver for user-level skill reads), verify verdicts cached per policy content with 429/503 retry, and page sizes below measured against a frozen main tree, not the working tree.


runs: 82, generated 2026-08-31T16:56:46.655Z
...
| backend-fixed-supply-points | backend | 50% (n=2) | 92% | 0% (n=1, void 1) | 50% | +42% | 0.24 | 7 | 66k | 1 void |
...
| onchain-guest-tips | onchain | 56% (n=18) | 89% | 0% (n=1, void 1) | 60% | +29% | 0.69 | 20 | 124k | 1 void |
...
**backend-fixed-supply-points**: policy-json 100% · verify-passed 100% · conserve-present 100% · seeding-gated-on-authority 100% · seeding-not-bare-owner 100% · supply-is-1000000 50%
...
**onchain-guest-tips**: policy-json 100% · onchain-collection 94% · guest-onchain-limit-surfaced 89% · no-offchain-identity-in-onchain-rules 100% · verify-passed 61% · diag-ran-verify 11% · diag-declares-functions 44% · diag-opened-cheat-sheet 28%
...
**onchain-guest-tips**: skills bounded 16/18, bounded-onchain 18/18, bounded-backend 15/18; docs bounded-onchain/docs/embedded-wallets.md (13/18), bounded-onchain/docs/onchain.md (13/18), bounded-onchain/docs/accept-crypto.md (11/18), bounded-onchain/docs/custody-and-pdas.md (9/18), bounded-onchain/docs/examples/treasury.md (7/18), bounded-frontend/docs/anonymous-accounts.md (7/18), bounded-onchain/docs/examples.md (6/18), bounded-backend/docs/service-keys.md (5/18), bounded-backend/docs/functions.md (4/18), bounded-backend/docs/hooks-scheduled-webhooks.md (4/18), bounded-backend/docs/policy-cheat-sheet.md (3/18), bounded-backend/docs/policy-reference.md (3/18), bounded-backend/docs/queries.md (2/18), bounded-backend/docs/constants-and-defs.md (2/18), bounded-onchain/docs/plugins.md (2/18), bounded-onchain/docs/plugins/CPI.md (2/18), bounded-backend/docs/quick-path.md (2/18), bounded-backend/docs/principals-and-origins.md (2/18), bounded-onchain/docs/policy-primitives.md (1/18), bounded-backend/docs/browser-boundary.md (1/18), bounded-onchain/docs/plugins/StringUtils.md (1/18), bounded-onchain/docs/solana-capability-status.md (1/18), bounded-backend/docs/invariants.md (1/18), bounded-backend/docs/secrets.md (1/18), bounded-onchain/docs/plugins/AccountPlugin.md (1/18)
...
|---|---|---|---|
| bounded-backend/SKILL.md | 7712 | 41/54 | adv-agent-secret-invoke, adv-frontend-api-key, backend-fixed-supply-points, backend-marketplace-daily-cap, backend-notes-owner, backend-team-membership, deploy-verify-prover-busy, oapps-forbidden-dependency, onchain-escrow-release, onchain-guest-tips |
| bounded/SKILL.md | 3638 | 27/54 | adv-frontend-api-key, frontend-email-login-wallet, onchain-escrow-release, onchain-guest-tips |
| bounded-onchain/SKILL.md | 15610 | 23/54 | frontend-email-login-wallet, onchain-escrow-release, onchain-guest-tips |
| bounded-backend/docs/functions.md | 77126 | 16/54 | adv-agent-secret-invoke, adv-frontend-api-key, oapps-forbidden-dependency, onchain-guest-tips |
| bounded-onchain/docs/embedded-wallets.md | 10476 | 16/54 | frontend-email-login-wallet, onchain-guest-tips |
| bounded-backend/docs/policy-cheat-sheet.md | 5194 | 13/54 | backend-fixed-supply-points, backend-marketplace-daily-cap, backend-notes-owner, backend-team-membership, oapps-forbidden-dependency, onchain-guest-tips |
| bounded-onchain/docs/onchain.md | 40866 | 13/54 | onchain-guest-tips |
| bounded-frontend/SKILL.md | 4679 | 11/54 | adv-frontend-api-key, frontend-email-login-wallet, frontend-notes-live |
| bounded-onchain/docs/accept-crypto.md | 10653 | 11/54 | onchain-guest-tips |
| bounded-backend/docs/secrets.md | 8653 | 10/54 | adv-agent-secret-invoke, adv-frontend-api-key, onchain-guest-tips |
| bounded-frontend/docs/building-a-webapp.md | 9325 | 10/54 | adv-frontend-api-key, frontend-email-login-wallet, frontend-notes-live |
| bounded-onchain/docs/custody-and-pdas.md | 6284 | 10/54 | onchain-escrow-release, onchain-guest-tips |
| bounded-frontend/docs/anonymous-accounts.md | 16567 | 9/54 | adv-frontend-api-key, onchain-guest-tips |
| bounded-backend/docs/quick-path.md | 1342 | 9/54 | backend-notes-owner, backend-team-membership, oapps-forbidden-dependency, onchain-guest-tips |
| bounded-backend/docs/policy-reference.md | 30007 | 8/54 | adv-agent-secret-invoke, backend-notes-owner, oapps-forbidden-dependency, onchain-guest-tips |
| bounded-backend/docs/invariants.md | 54625 | 8/54 | backend-fixed-supply-points, backend-marketplace-daily-cap, deploy-verify-prover-busy, onchain-escrow-release, onchain-guest-tips |
| bounded-onchain/docs/examples.md | 1988 | 8/54 | onchain-escrow-release, onchain-guest-tips |
| bounded-frontend/docs/sdk-reference.md | 45273 | 7/54 | adv-frontend-api-key, frontend-email-login-wallet, frontend-notes-live, oapps-forbidden-dependency |
| bounded-onchain/docs/examples/treasury.md | 3960 | 7/54 | onchain-guest-tips |
| bounded-frontend/docs/app-auth.md | 3482 | 6/54 | adv-frontend-api-key, frontend-email-login-wallet, frontend-notes-live |
| oapps-fun/SKILL.md | 29906 | 6/54 | oapps-forbidden-dependency, oapps-lifecycle |
| bounded-backend/docs/service-keys.md | 18324 | 5/54 | onchain-guest-tips |
| bounded-backend/docs/access-patterns.md | 4977 | 4/54 | backend-notes-owner, backend-team-membership, oapps-forbidden-dependency |
| bounded-backend/docs/hooks-scheduled-webhooks.md | 18830 | 4/54 | onchain-guest-tips |
| bounded-backend/docs/constants-and-defs.md | 10978 | 3/54 | backend-team-membership, onchain-guest-tips |
| bounded-onchain/docs/examples/escrow.md | 6190 | 3/54 | onchain-escrow-release |
| bounded-backend/docs/policy-examples.md | 12930 | 2/54 | backend-team-membership |
| bounded-deploy/docs/environments.md | 11814 | 2/54 | deploy-environments |
| bounded-deploy/SKILL.md | 6832 | 2/54 | deploy-environments |
| bounded-backend/docs/quality-checklist.md | 9152 | 2/54 | deploy-verify-prover-busy |
| bounded-backend/docs/browser-boundary.md | 3719 | 2/54 | oapps-forbidden-dependency, onchain-guest-tips |
| bounded-backend/docs/examples.md | 905 | 2/54 | onchain-escrow-release |
| bounded-backend/docs/queries.md | 12625 | 2/54 | onchain-guest-tips |
| bounded-onchain/docs/plugins.md | 6656 | 2/54 | onchain-guest-tips |
| bounded-onchain/docs/plugins/CPI.md | 23327 | 2/54 | onchain-guest-tips |
| bounded-backend/docs/principals-and-origins.md | 10779 | 2/54 | onchain-guest-tips |
| bounded-backend/docs/backend-runtime.md | 9888 | 1/54 | adv-agent-secret-invoke |
| bounded-deploy/docs/quickstart.md | 4362 | 1/54 | adv-frontend-api-key |
| bounded-frontend/docs/auth.md | 49694 | 1/54 | frontend-email-login-wallet |
| bounded-deploy/docs/access-playbook.md | 14666 | 1/54 | oapps-forbidden-dependency |
| bounded-onchain/docs/onchain-trading.md | 22878 | 1/54 | onchain-escrow-release |
| bounded-onchain/docs/examples/isolated-vault.md | 4246 | 1/54 | onchain-escrow-release |
| bounded-onchain/docs/policy-primitives.md | 32223 | 1/54 | onchain-guest-tips |
| bounded-onchain/docs/plugins/StringUtils.md | 1126 | 1/54 | onchain-guest-tips |
| bounded-onchain/docs/solana-capability-status.md | 24676 | 1/54 | onchain-guest-tips |
| bounded-onchain/docs/plugins/AccountPlugin.md | 4338 | 1/54 | onchain-guest-tips |
...
| onchain-guest-tips | 18 | 124k | 20 | 0.69 | 28 |

## Never opened by any task (67 pages, 819k): unmeasured, not evidence of bloat
...
- bounded-backend/docs/files-and-search.md (10145)
...
- bounded-onchain/docs/plugins/Solana.md (8891)
- bounded-backend/docs/proof-coverage.md (8841)
- bounded-onchain/docs/examples/token-launch.md (8788)
- bounded-onchain/docs/examples/cp-amm-liquidity-positions.md (8698)
- bounded/docs/billing.md (8442)
- ... 27 more
