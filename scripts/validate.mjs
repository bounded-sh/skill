...
if (!solanaInventory) {
  ...
  if (rows.length !== 160) fail(`Solana capability status: expected 160 function rows, received ${rows.length}`)
  ...
  for (const [state, count] of Object.entries({ unverified: 128, unsupported: 32, blocked: 0 })) {
