...
if (!solanaInventory) {
  ...
  if (rows.length !== 163) fail(`Solana capability status: expected 163 function rows, received ${rows.length}`)
  ...
  for (const [state, count] of Object.entries({ unverified: 130, unsupported: 33, blocked: 0 })) {
