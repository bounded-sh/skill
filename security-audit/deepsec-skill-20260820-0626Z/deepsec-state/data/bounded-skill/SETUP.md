# Agent setup for `bounded-skill`

This is a deepsec scanning workspace. Project `bounded-skill` was just registered
(target: `../../..`). Setup is incomplete - `data/bounded-skill/INFO.md`
...
2. **Fill in `data/bounded-skill/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id bounded-skill
pnpm deepsec process --project-id bounded-skill
```
