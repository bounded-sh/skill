...
| Accept crypto / USDC, `payments.acceptCrypto`, get paid to a wallet non-custodially, seller settlement + notification, direct-transfer rail | [docs/accept-crypto.md](docs/accept-crypto.md) |
