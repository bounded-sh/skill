...
| `@TokenPlugin` | SPL and Token-2022 tokens: transfers, mints, burns, balances, supply. | `burn`, `createToken`, `createToken2022`, `mint`, `revokeMintAuthority`, `transfer`, `transferWholeTokens`, `withdrawWithheldTokens`, `getBalance`, `getDecimals`, `getSupply`, `getTokenMintAddress`, `getWithdrawWithheldAuthority` | [reference](plugins/TokenPlugin.md) |
